...
-- Records of products
-- ----------------------------
INSERT INTO `products` VALUES (1, 'BMW M4', 'Siêu xe chuyên dụng để chạy Grab, có động cơ 1000 mã lực', 'BMW M4 được bán dưới dạng một chiếc coupe hoặc convertible, tính năng quan trọng nhất là chiếc V-8 6.2 lít tăng áp làm cho 650 mã lực và 650 lb-ft', 700000, 1, 50, 'BMW', 38, 'Germany', '20/06/2018');
INSERT INTO `products` VALUES (2, 'BMW M6 Gran', 'Siêu xe chuyên dụng để chạy Grab, có động cơ 1000 mã lực', 'BMW M6 Gran là vua của những chiếc xe cơ bắp. Cả hai chiếc coupe và nhà chuyển đổi một hung dữ 650 mã lực tăng áp 6.2 lít V-8 tặng bởi Corvette Z06', 50000, 1, 40, 'BMW', 10, 'Germany', '20/06/2018');
INSERT INTO `products` VALUES (3, 'BMW I8', 'Siêu xe chuyên dụng để chạy Grab, có động cơ 1000 mã lực', 'BWm I8 coupe là siêu xe cực kỳ mạnh mẽ. Một người bạn V-10 5.2 lít kỳ lạ với một ly hợp kép tự động bảy tốc độ . Mã lực dao động từ 572', 203295, 1, 120, 'BMW', 1, 'Germany', '20/06/2018');
...
INSERT INTO `products` VALUES (5, 'Mercedes-Benz S65 AMG', 'Mercedes-Benz cùng sử dụng chung động cơ V8, tăng áp kép', 'Mercedes-Benz S65 AMG trang bị động cơ V12, tăng áp kép, dung tích 6 lít  cho công suất cực đại 621 mã lực, mô-men xoắn cực đại 1.000 Nm', 58450, 1, 45, 'Mercedes-Benz', 3, 'Germany', '16/06/2018');
...
INSERT INTO `products` VALUES (20, 'Lexus LS Hybrid', 'Lexus LS Hybrid 2018 là thế hệ thứ 8 của dòng Lexu trứ danh về sự sang trọng', 'Xe được trang bị động cơ Biturbo V12 6,6 lít cho ra công suất 563 mã lực và 820Nm mô-men xoắn cực đại xe dễ dàng tăng tốc từ 0 – 96 km/h chỉ với 4,9 giây', 700000, 4, 35, 'Lexus', 14, 'Japan', '22/06/2018');
INSERT INTO `products` VALUES (21, 'Lexus GS F', 'Lexus GS F 2018 là phiên bản trục dài của chiếc sedan hạng sang thể thao', 'Lexus GS F trang bị tất cả các tùy chọn động cơ , từ động cơ 3.0L đến động cơ V8 twin turbo 4.0L  trên Panamera Turbo Executive, động cơ 4.0L mạnh mẽ', 439000, 4, 67, 'Lexus', 2, 'Japan', '22/06/2018');
